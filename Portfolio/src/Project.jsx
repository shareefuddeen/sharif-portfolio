...
const Project = () => {
    return (
        <section id='project' className='Project mt-44'>
            <h1 className='text-4xl tracking-widest font-extrabold  mb-14 z-index-1 text-center bg-gradient-to-tr from-teal-500 to-teal-900 text-transparent bg-clip-text'>Projects</h1>
