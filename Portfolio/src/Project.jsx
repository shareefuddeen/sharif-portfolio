    ...
    return (
        <section id='project' className=' mt-44 '>
            ...
            <InView triggerOnce={false} threshold={0.01}>
                {({ inView, ref }) => (
                    <div ref={ref} className={`animate-from-right w-full mx-auto transition duration-500 rounded-lg p-2 text-gray-300 text-center tracking-wide leading-6 ${inView ? 'show-animate' : ''}`}>
